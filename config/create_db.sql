...
CREATE TABLE Users(
  usr_ID_PK INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Games(
  gm_ID_PK INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE User2Game(
  usr2gm_ID_PK INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  gm_ID_FK INT NOT NULL,
  usr_ID_FK INT NOT NULL,
  usr2gm_Port INT NOT NULL,
  CONSTRAINT fk_gm_id
